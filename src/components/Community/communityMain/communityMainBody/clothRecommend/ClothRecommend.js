                    ...
                    arr.push(
                        <div>
                            <tr className='content2'>
                                ...
                                {
                                    community[i].boardTitle.length > 25 ? community[i].boardTitle.substr(0, 25) + '......' :community[i].boardTitle
                                }
                            </tr>
                        </div>
                    )
                                ...
                                boardCommunity && boardCommunity
                                    ...
                                    .map((data) => (
                                        <div id="rank1" key={data.boardId}>
                                            {
                                                data.boardTitle.length > 12 ? data.boardTitle.substr(0, 12) + '......' : data.boardTitle
                                            }
                                        </div>
                                    ))
                            }
